...
import utility.CartPage;
import utility.ConatctPage;
import utility.LoginPage;

import utility.ProfileManagement;
import utility.SearchProduct;

public class BasePage {
	WebDriver driver;
	public SearchProduct searchProduct;
	public ProfileManagement profileManagement;
	public ConatctPage contactPage;
	...
	public SearchProduct launchApplication() throws IOException {
		...
		profileManagement=new ProfileManagement(driver);
		contactPage =new ConatctPage(driver);
