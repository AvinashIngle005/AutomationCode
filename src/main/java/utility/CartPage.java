...
public class CartPage extends CommonUtility{
	...
	public void checkoutProcess(String product,String city,String address, String pincode) throws InterruptedException {
			...
			Thread.sleep(5000);
			cartButton.click();
			Assert.assertTrue(cartProductName.getText().equalsIgnoreCase(product),"Product in the cart matched with added product"); 
